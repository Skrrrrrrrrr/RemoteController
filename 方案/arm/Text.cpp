...
void Get_HzMat(const char *code, uint8_t *mat, uint8_t size, uint8_t Font)
{		    
	unsigned char qh,ql;
	unsigned char i;					  
...
void Show_Font(uint16_t x,uint16_t y,const char *font,uint8_t size,uint16_t color,uint8_t mode)
{
	uint8_t temp,t,t1;
	uint16_t x0=x;
	uint8_t dzk[72];
...
//淘宝店铺：shop389957290.taobao.com
/**************************************************************************************/
void Show_Str(uint16_t x,uint16_t y,uint16_t width,uint16_t height, const char*str, uint8_t size, uint16_t color, uint8_t mode)
{					
	uint16_t x0=x;
	uint16_t y0=y;							  	  
...
void Draw_Font16B(uint16_t x,uint16_t y, uint16_t color, const char*str)
{
	uint16_t width;
	uint16_t height;
	
	width=LcdDevEBox::instance().lcdDev.width-x;
	height=LcdDevEBox::instance().lcdDev.height-y;
...
void Draw_Font24B(uint16_t x,uint16_t y, uint16_t color, const char*str)
{
	uint16_t width;
	uint16_t height;
